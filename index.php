...
<head>
    <meta charset="UTF-8">
    <title>Trinetra - A finest Supermarket Management Platform</title>
...
<div class="welcome-text">
        <h1>
Trinetra <span>SuperMarket</span></h1>
      ...
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1" ><br>
          ...
          <p style="font-size: 120%;">
            Trinetra is a youth-based supermarket working towards a better and egalitarian society.
<br><br>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="contact-about">
            <h3 style="color:#360d46">TRINETRA</h3>
