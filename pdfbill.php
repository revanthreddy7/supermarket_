...
while($item=mysqli_fetch_assoc($result6))
{
  ...
  $y = $pdf -> GetY();
  $pdf->Multicell(60,8,"abc",1,'C',1,1);
  $x = $pdf -> GetX();
  $pdf->setXY($x+60,$y);
  $pdf->Multicell(25,8,"cde",1,'C',1,1);
  $pdf->setXY($x+85,$y);
  $pdf->Multicell(25,8,"efg",1,'C',1,1);
  $pdf->setXY($x+110,$y);
  $pdf->Multicell(25,8,"fgh",1,'C',1,1);
  $pdf->setXY($x+135,$y);
